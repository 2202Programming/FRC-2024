...
public class PoseMath {
  ...
  // return angle between virtual target and actual target, from point of view of
  // robot pose
  public static Rotation2d angleVirtualTarget(Pose2d robotPose, Pose2d actualTarget, Pose2d virtualTarget) { // law of
                                                                                                             // cosines
                                                                                                             // γ=cos-1(a2+b2﹣c2)/2ab)
